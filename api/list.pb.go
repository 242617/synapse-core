...
var fileDescriptor_af793ce248ee1bf0 = []byte{
	...
	0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4e, 0x2c, 0xc8, 0x54, 0x52, 0xe2, 0xe2, 0xf1,
	...
	0x8a, 0x60, 0x5c, 0x23, 0x0b, 0x2e, 0x16, 0x9f, 0xcc, 0xe2, 0x12, 0x21, 0x03, 0x2e, 0x8e, 0xe0,
	0xc4, 0x4a, 0xb0, 0x16, 0x21, 0x41, 0xbd, 0xc4, 0x82, 0x4c, 0x3d, 0x64, 0x2b, 0xa4, 0xf8, 0x91,
	0x85, 0x0a, 0x72, 0x2a, 0x95, 0x18, 0x92, 0xd8, 0xc0, 0x2e, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff,
	0xff, 0x31, 0xd2, 0xfd, 0x6a, 0x9f, 0x00, 0x00, 0x00,
}
...
func (c *listClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/api.List/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedListServer) SayHello(ctx context.Context, req *HelloRequest) (*HelloReply, error) {
...
func _List_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ListServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.List/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListServer).SayHello(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _List_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.List",
	HandlerType: (*ListServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _List_SayHello_Handler,
		},
	},
