...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Crawler.certificate":
		if e.complexity.Crawler.Certificate == nil {
			break
		}
	...
	case "Crawler.id":
		...
		return e.complexity.Crawler.ID(childComplexity), true

	case "Crawler.name":
		if e.complexity.Crawler.Name == nil {
			break
		}
	...
	case "Mutation.createCrawler":
		...
		args, err := ec.field_Mutation_createCrawler_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) field_Mutation_createCrawler_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) _Crawler_id(ctx context.Context, field graphql.CollectedField, obj *model.Crawler) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Crawler_certificate(ctx context.Context, field graphql.CollectedField, obj *model.Crawler) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_createCrawler(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	args, err := ec.field_Mutation_createCrawler_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateCrawler(rctx, args["input"].(model.NewCrawler))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewCrawler(ctx context.Context, obj interface{}) (model.NewCrawler, error) {
	var it model.NewCrawler
...
var crawlerImplementors = []string{"Crawler"}

func (ec *executionContext) _Crawler(ctx context.Context, sel ast.SelectionSet, obj *model.Crawler) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, crawlerImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Crawler")
		case "id":
			out.Values[i] = ec._Crawler_id(ctx, field, obj)
